...
let getGroups = () => [
    new Group("all",["other",""],"All projects",new ItemDate(TODAY.getDate(),TODAY.getMonth()+1,TODAY.getFullYear()),null,["home"],{},true),
...
let getItems = () => [
    ...
    new Item(null,[],"https://www.reddit.com/r/PixelArt/comments/qi9rq8/the_crocus/","/crocus","Wonderfull spice","/crocus-base.webp","Common plant that grows in every mountain meadow - Crocus! Also the most expensive spice in the world!",new ItemDate(20, 10, 2021),null,["best","pixel-plants"]),
