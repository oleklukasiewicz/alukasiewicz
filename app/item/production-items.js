...
let getGroups = () =>
    ...
    getItems = () => [
        new Item(null,[],"https://www.instagram.com/p/Cd3DiBBqvOR/","/orchid","The Orchid","/orchid.webp","A flower considered a symbol of beauty and love that grows on trees or between rocks rather than directly in the ground.",new ItemDate(22,5,2022),undefined,["featured"]),
        new Item(null,[],"https://www.instagram.com/p/CdqCxFOq1fh/","/crocus","The Crocus","/crocus-base.webp","One of the first signs of spring - crocus, also know as the source of one of the most expensive spice.",new ItemDate(17,5,2022),undefined,["featured"]),
