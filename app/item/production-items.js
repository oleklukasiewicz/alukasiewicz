...
let getGroups = () =>
    ...
    getItems = () => [
        new Item(null,[],"https://www.instagram.com/p/CdqCxFOq1fh/","/crocus","The Crocus","/crocus-base.webp","One of the first signs of spring - crocus, also know as the source of one of the most expensive spice.",new ItemDate(1,5,2022),undefined,["featured","organic-group"]),
